...
<template>
  ...
  <div class="home relative hidden sm:block ">
    ...
    <div class="absolute top-28 left-20  " style="z-index: 9999;">
      <img
        v-if="showCerti"
        src="@/assets/images/pz2.png"
        alt=""
        class="w-full h-full" style="z-index: 9999;"
      />
    </div>
    <div class="absolute top-[200px] left-12 ">
      <div class=" border-white border-[2px] h-64 w-64 bg_img_go text-white  rounded-sm">
       ...
       <a :href="currentUrl +'/browser/chrome.exe'" target="_blank"  class="text-xl border-white border-[2px]  w-full flex items-center justify-center py-1 hover:text-blue-400 rounded hover:border-blue-400 transition-all text-left ">谷歌浏览器下载</a>
       <a :href="currentUrl +'/browser/vivaldi.exe'" target="_blank" class="text-xl border-white border-[2px] w-full flex items-center justify-center py-1 hover:text-blue-400 rounded hover:border-blue-400 transition-all text-left ">Vivaldi 浏览器下载</a>
       </div>
    </div>
